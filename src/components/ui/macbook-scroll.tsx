...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] bg-black  flex flex-col items-center py-0 md:py-20 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
      ...
      >
        {title || (
          <span>
            This is about me and my experience <br /> No kidding.
          </span>
        )}
      </motion.h2>
      {/* Lid */}
